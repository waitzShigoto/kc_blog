...
<div class="c-border-content-title-4">什麼是AIDL呢？
</div>
...
<div class="c-border-content-title-4">例如:
</div>
...
<div class="c-border-content-title-1">步驟1 : 先定義AIDL介面 
</div>
...
<div class="c-border-content-title-1">步驟2 : 實作Service
</div>
...
<div class="c-border-content-title-1">步驟3 : 加入Service至Manifest.xml
</div>
...
<div class="c-border-content-title-1">步驟4 : 實作Intent bind service
</div>
...
<div class="c-border-content-title-1">(選擇性) 步驟5-其他用例
</div>
...
<div class="c-border-content-title-4">注意2：Android官方在Android 9之後有更新新的反射政策，不確定這個還可否使用，因為那時候該機型OTA目標版本是5~8，可自行實測</div>

<div class="c-border-content-title-1">(選擇性) 步驟6-其他用例:AIDL支援類型有限</div>
...
<div class="c-border-content-title-1">(選擇性) 步驟7-其他用例:AIDL包成Jar檔
</div>
