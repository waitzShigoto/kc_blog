          ...
          <div className="flex flex-wrap gap-3">
            {siteConfig.author.social.github && (
              <a
                ...
                className="w-8 h-8 bg-muted hover:bg-secondary rounded-full flex items-center justify-center transition-colors"
                title="GitHub"
              >
                <svg className="w-4 h-4 text-muted-foreground hover:text-foreground" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a
              href="https://instagram.com/eleg.aces.kc"
              target="_blank"
              rel="noopener noreferrer"
              className="w-8 h-8 bg-muted hover:bg-secondary rounded-full flex items-center justify-center transition-colors"
              title="Instagram"
            ...
            <a
              href="https://youtube.com/channel/UC9iPx_SGYocVfTMMX7sdXdA"
              target="_blank"
              rel="noopener noreferrer"
              className="w-8 h-8 bg-muted hover:bg-secondary rounded-full flex items-center justify-center transition-colors"
              title="YouTube"
            ...
            <a
              href="https://facebook.com/eleg.aces"
              target="_blank"
              rel="noopener noreferrer"
              className="w-8 h-8 bg-muted hover:bg-secondary rounded-full flex items-center justify-center transition-colors"
              title="Facebook"
