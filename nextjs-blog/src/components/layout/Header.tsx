          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="relative">
              <select
                ...
                className="bg-transparent border border-gray-300 dark:border-gray-600 rounded px-3 py-1 text-sm text-gray-700 dark:text-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500"
              >
                {languages.map((lang) => (
